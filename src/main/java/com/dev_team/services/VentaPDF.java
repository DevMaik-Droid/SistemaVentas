...
import com.dev_team.vistas.InterFacturacion;
...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String nombre = "CARIJ Cooporation";
            String telefono = "22843400";
            String direccion = "Universidad Publica De El Alto";
            ...
            PdfPCell cliente1 = new PdfPCell(new Phrase("Cedula/C.I: ", negrita));
