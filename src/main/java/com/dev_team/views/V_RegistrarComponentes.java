...
public class V_RegistrarComponentes extends JPanel{
    ...
    private void initComponents() {
        ...
        lb_2.setText("Modelo:");
        panel_form.add(lb_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 120, -1, -1));
        ...
        panel_form.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, -1, -1));

        jLabel14.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        jLabel14.setForeground(Main_Colores.C_100);
        jLabel14.setText("Cantidad:");
        panel_form.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, -1, -1));
        ...
        panel_form.add(btn_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 320, 130, 50));

        cbx_componente.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        cbx_componente.setForeground(Main_Colores.Fondo);
        cbx_componente.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione componente:", "Placa Base (Motherboard)", "Procesador (CPU)", "Memoria RAM", "Almacenamiento (HDD)", "Almacenamiento (SDD)", "Tarjeta grafica (GPU)", "Fuente Alimentacion", "Case", "Disipador", "Ventiladores" }));
        ...
        panel_form.add(cbx_proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 290, 220, 30));
        ...
        panel_form.add(tf_cantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 370, 130, 40));

        lb_6.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        lb_6.setForeground(Main_Colores.C_100);
        lb_6.setText("Precio:");
        panel_form.add(lb_6, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 340, -1, -1));

        tf_precio.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        tf_precio.setForeground(Main_Colores.Fondo);
        panel_form.add(tf_precio, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 370, 140, 40));
        ...
        panel_form.add(tf_modelo, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 330, 30));

        panel_form.add(cbx_capacidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, 210, -1));

        panel_form.add(cbx_velocidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 220, 210, -1));
